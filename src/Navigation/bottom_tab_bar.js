        ...
        <Tab.Navigator
            screenOptions={({ route }) => ({
                ...
                tabBarIcon: ({ focused, color, size }) => {
                    let iconName;
                    if (route.name === routes(t).News) {
                        iconName = focused
                            ? 'md-home'
                            : 'md-home-outline';
                    } else if (route.name === routes(t).Settings) {
                        iconName = focused ? 'settings' : 'settings-outline';
                    }
                    return <Ionicons name={iconName} size={size} color={color} />;
                },
            })}>
            <Tab.Screen name={routes(t).News} component={HomeScreen} />
            <Tab.Screen name={routes(t).Settings} component={SettingsScreen} />
        </Tab.Navigator>);
}
